...
public class Jyanken_Chapter24 {
	...
	public void playGame() {
		...
		hand.put("s", "チョキ");
		hand.put("p", "パー");
		System.out.println("自分の手は" + hand.get(input));
		System.out.println("対戦相手は"+ hand.get(PC));
		
		if(input.equals(PC)) {
			System.out.println("あいこです");
	}
		else if(input.equals("s")&&(PC.equals("r"))||
				(input.equals("p")&&(PC.equals("s")))||
				(input.equals("r")&&(PC.equals("p")))) {
			System.out.println("相手の勝ちです");
		}else {
			System.out.println("相手の負けです");
		}
